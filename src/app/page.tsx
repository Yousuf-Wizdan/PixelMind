...
export default function HomePage() {
  const features = [
    {
      ...
      color: "text-teal-600",
      bgColor: "bg-gradient-to-br from-teal-100 to-teal-200/70",
    },
    {
    ...
    },
    {
      ...
      bgColor: "bg-gradient-to-br from-purple-100 to-purple-200/70",
    },
    {
      ...
      bgColor: "bg-gradient-to-br from-amber-100 to-amber-200/70",
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-blue-50/30 to-teal-50/40">
      {/* Navigation */}
      <nav className="sticky top-0 z-50 border-b border-purple-200/40 bg-white/80 backdrop-blur-xl supports-[backdrop-filter]:bg-white/70">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex h-16 items-center justify-between">
            <div className="flex items-center gap-2">
              <div className="flex h-8 w-8 items-center justify-center rounded-xl bg-gradient-to-r from-purple-600 to-blue-600 shadow-lg shadow-purple-500/25">
                <Sparkles className="h-5 w-5 text-white" />
              </div>
              <span className="bg-gradient-to-r from-purple-600 via-blue-600 to-teal-600 bg-clip-text text-xl font-bold text-transparent">
                PixelMind
              </span>
            </div>
            ...
            <div className="flex items-center gap-3">
              <Link href="/auth/sign-in">
                <Button variant="ghost" size="sm" className="cursor-pointer font-medium hover:bg-purple-50 hover:text-purple-700">
                  Sign In
                </Button>
              </Link>
              <Link href="/dashboard">
                <Button size="sm" className="cursor-pointer gap-2 bg-gradient-to-r from-purple-600 to-blue-600 shadow-lg shadow-purple-500/25 hover:from-purple-700 hover:to-blue-700">
                  Try Free
      ...
      <section className="relative overflow-hidden py-20 sm:py-32">
        <div className="absolute inset-0 -z-10">
          <div className="absolute left-1/2 top-0 h-[500px] w-[500px] -translate-x-1/2 rounded-full bg-gradient-to-r from-purple-400/20 to-blue-400/20 blur-3xl"></div>
          <div className="absolute right-1/4 top-1/3 h-[400px] w-[400px] rounded-full bg-gradient-to-r from-teal-400/15 to-purple-400/15 blur-3xl"></div>
        </div>
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-4xl text-center">
            <div className="mb-8 inline-flex items-center gap-2 rounded-full border border-purple-200/60 bg-gradient-to-r from-purple-100/50 to-blue-100/50 px-4 py-2 text-sm shadow-lg backdrop-blur-sm">
              <Sparkles className="h-4 w-4 text-purple-600" />
              <span className="font-medium bg-gradient-to-r from-purple-700 to-blue-700 bg-clip-text text-transparent">
            ...
            <div className="flex flex-col gap-4 sm:flex-row sm:justify-center">
              <Link href="/dashboard">
                <Button
                  size="lg"
                  className="cursor-pointer gap-2 px-8 py-6 text-base bg-gradient-to-r from-purple-600 to-blue-600 shadow-xl shadow-purple-500/25 hover:from-purple-700 hover:to-blue-700 transition-all duration-200"
                >
            ...
            <div className="mt-16 text-center">
              ...
              <div className="grid grid-cols-2 items-center justify-center gap-6 sm:grid-cols-5">
                <div className="text-center p-4 rounded-lg bg-white/50 backdrop-blur-sm border border-purple-200/30 shadow-sm">
                  <div className="text-2xl font-bold bg-gradient-to-r from-purple-600 to-blue-600 bg-clip-text text-transparent">10K+</div>
                  <div className="text-xs text-gray-500">Images Processed</div>
                </div>
                <div className="text-center p-4 rounded-lg bg-white/50 backdrop-blur-sm border border-blue-200/30 shadow-sm">
                  <div className="text-2xl font-bold bg-gradient-to-r from-blue-600 to-teal-600 bg-clip-text text-transparent">2.5K+</div>
                  <div className="text-xs text-gray-500">Active Users</div>
                </div>
                <div className="text-center p-4 rounded-lg bg-white/50 backdrop-blur-sm border border-teal-200/30 shadow-sm">
                  <div className="text-2xl font-bold bg-gradient-to-r from-teal-600 to-purple-600 bg-clip-text text-transparent">99.9%</div>
                  <div className="text-xs text-gray-500">Uptime</div>
                </div>
                <div className="text-center p-4 rounded-lg bg-white/50 backdrop-blur-sm border border-amber-200/30 shadow-sm">
                  <div className="text-2xl font-bold text-amber-600">4.8★</div>
                  <div className="text-xs text-gray-500">User Rating</div>
                </div>
                <div className="col-span-2 text-center sm:col-span-1 p-4 rounded-lg bg-white/50 backdrop-blur-sm border border-gray-200/30 shadow-sm">
                  <div className="text-2xl font-bold bg-gradient-to-r from-gray-600 to-gray-700 bg-clip-text text-transparent">24/7</div>
      ...
      {/* Features Section */}
      <section id="features" className="bg-gradient-to-br from-white via-purple-50/30 to-blue-50/20 py-20 sm:py-32">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
            {features.map((feature, index) => (
              <Card
                key={index}
                className="group relative overflow-hidden border-purple-200/30 bg-white/80 backdrop-blur-sm transition-all hover:shadow-xl hover:shadow-purple-500/10 hover:-translate-y-1"
              >
                <CardContent className="p-6">
                  <div
                    className={`${feature.bgColor} mb-4 inline-flex items-center justify-center rounded-xl p-3 ${feature.color} shadow-lg`}
                  >
                    {feature.icon}
                  </div>
                ...
                <div className="absolute inset-0 bg-gradient-to-r from-purple-500/0 to-blue-500/5 opacity-0 transition-opacity group-hover:opacity-100" />
              </Card>
            ))}
          </div>
        </div>
      ...
      <section className="bg-gradient-to-br from-gray-50 via-blue-50/40 to-purple-50/30 py-20 sm:py-32">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mx-auto mb-16 max-w-2xl text-center">
            <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
